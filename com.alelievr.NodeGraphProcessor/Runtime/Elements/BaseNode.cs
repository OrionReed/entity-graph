...
namespace GraphProcessor
{
  ...
  public abstract class BaseNode
  {
    ...
    /// <summary>
    /// Triggered just before processing. Useful for halting execution.
    /// </summary>
    public event Action onBeforeProcessed;
    /// <summary>
    ...
    public void InvokeOnBeforeProcessed() => onBeforeProcessed?.Invoke();
